 ...
 *              2) java Greenhouse
 * Ensure that the plan file is present in the same directory as Greenhouse.java and named greenhouse_plan.txt. If there is no plan file present, the Greenhouse class will not have any events to schedule, and no light toggling will occur when executing the program.
 *
 * Classes:
 * - Light:
